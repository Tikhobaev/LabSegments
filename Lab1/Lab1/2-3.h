...
//struct two3node
//{
//    seg k1, k2;                               //Key values
//    two3node * left;
//    two3node * middle;                  //Child Pointers
//    two3node * right;
...
//struct usefulData
//{
//    seg midValue;             //Will be useful only in case of split operation and will be useless in case of merge operation
//    two3node * child;
//
//    usefulData()
//    {
...
//
//    // Copy Constructor
//    two3Tree(const two3Tree<seg>& otherTree)
//    {
//
//    }
//
...
//
//    //Overloaded Assignment Operator
//    two3Tree<seg> operator = (const two3Tree<seg>& otherTree)
//    {
//
//    }
//
...
//
//
//    usefulData rotateRight(two3node* p, two3node* r, seg d, two3node* child)
//    {
//
...
//
//
//    usefulData rotateLeft(two3node* p, two3node* r, seg d, two3node* child)
//    {
//
//        /*CASE 1 :  If the rotation is done to overcome the UNDERFLOW at r*/
//        if (r->n == 0)
...
//
//    //Recursive Function
//    usefulData insert(two3node* & r, seg d, two3node* p)
//    {
//        //Case 1 (Empty Tree)
...
//
//
//    usefulData split3node(two3node* current, seg k, two3node* child)
//    {
...
//
//    //Recursive Function
//    usefulData Delete(two3node* r, seg d, two3node* p)
//    {
